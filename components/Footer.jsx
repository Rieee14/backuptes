        ...
        <div className="grid md:grid-cols-3 gap-12">
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 pt-2">
              {/* Social Media Icons */}
              <a href="mailto:educare.id@gmail.com" className="w-10 h-10 rounded-full bg-yellow-500/10 flex items-center justify-center hover:bg-yellow-500/20 transition cursor-pointer group">
              ...
              <a href="https://instagram.com/educare.id" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-yellow-500/10 flex items-center justify-center hover:bg-yellow-500/20 transition cursor-pointer group">
            ...
            <div className="space-y-4">
              <div className="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <a href="mailto:educare.id@gmail.com" className="text-sm text-slate-200 font-medium hover:text-yellow-400 transition">
                    educare.id@gmail.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3 group">
                ...
                <div>
                  ...
                  <a href="https://instagram.com/educare.id" target="_blank" rel="noopener noreferrer" className="text-sm text-slate-200 font-medium hover:text-yellow-400 transition">
                    @educare.id
                  </a>
                </div>
              </div>
